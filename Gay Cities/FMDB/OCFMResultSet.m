...
@interface OCFMResultSet (Private)
- (NSMutableDictionary *)columnNameToIndexMap;
- (void)setColumnNameToIndexMap:(NSMutableDictionary *)value;
@end

@implementation OCFMResultSet

+ (id) resultSetWithStatement:(OCFMStatement *)statement usingParentDatabase:(OCFMDatabase*)aDB {
    
    OCFMResultSet *rs = [[OCFMResultSet alloc] init];
...
- (void)setParentDB:(OCFMDatabase *)newDb {
    parentDB = newDb;
}
...
- (OCFMStatement *) statement {
    return statement;
}

- (void)setStatement:(OCFMStatement *)value {
    if (statement != value) {
        [statement release];
